    ...
    >
      ...
      >
        <div class="text-h5 q-pb-lg text-green-10   ">Estate Details</div>
         <q-input v-model="record.estate.name" type="text" label="Estate Name"  class="q-pb-md" outlined  />
            <q-select v-model="record.estate.estate_type_id"
                  :options="getEstateType" option-value="id" option-label="name" class="q-pb-md"
                   emit-value  map-options label="Type"   outlined />
          <q-input v-model="record.estate.total_house" type="number" label="Total Number of Houses" outlined   />
      </q-step>
      ...
      >
       <div class="q-gutter-md  ">
         <div class="text-h5  items-center text-green-10">Estate Address</div>
              ...
              <q-input v-model="record.estate.street1" type="text" label="Street"  outlined />
            <q-input v-model="record.estate.city" type="text" label="City" outlined />
            <q-input v-model="record.estate.state_region" type="text" label="State or Region"  outlined  />
            <!-- <q-input v-model="estate.country" type="text" label="Country" outlined  /> -->
            <q-select v-model="record.estate.country"  label="Countries"
      ...
      >
       <div class="q-gutter-md">
          <div class="text-h5  items-center text-green-10">Your Personal Info</div>
              <q-input v-model="record.account.first_name"     label="First Name"  outlined  />
              <q-input v-model="record.account.last_name"    label="Last Name" outlined  />
              <q-input v-model="record.account.phone"    label="Phone Number"  outlined />
      ...
      >
      <div class="q-gutter-md">
        <q-input v-model="record.resident.house_address"    label="Your address in the estate eg. block 1 house 2"  outlined />
        <q-input v-model="record.estate.comment" type="textarea" label="what would you like to say to new residents joining in" dense   outlined   />
      </div>
      </q-step>
...
export default {
  ...
  methods:{
    ...
    onSubmit(){
      ...
      window.$vm=this.record
      console.log('all objs : ', this.record);
      var newestate=this.register_estate_resident(this.record)
